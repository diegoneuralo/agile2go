...
public class AuthenticationService extends BaseAuthenticator implements Authenticator, Serializable {	
	...
	public void authenticate() {
		...
		User user = userService.getUserByIdentityKey(credentials.getUsername(), credentials.getPassword());
		if (user != null && credentials.getCredential() instanceof PasswordCredential && 
			...
			setUser(new SimpleUser(user.getLogin())); //TODO confirm the need for this set method
			return;
		}
