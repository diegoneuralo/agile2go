package br.com.scrum.view.util;
...
public final class Validate {
   ...
   public static void notNull (final Object obj) throws BusinessException {
      if ( obj == null )  throw new BusinessException("valor não pode ser nulo");
   }
   ...
   public static void notBlank (final String string) throws BusinessException {
      if ( string == null || string.length() == 0 )  throw new BusinessException("valor não pode ser nulo e nem vazio");     
   }
